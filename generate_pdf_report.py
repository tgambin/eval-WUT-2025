...
pdf.chapter_body(
    ...
    'i algorytmicznych, opracowanych lub współtworzonych przez Tomasza Gambina. Pozwoliły one na odkrycie wariantów '
    'niewykrywalnych standardowymi metodami:\n\n'
    '1. Algorytm HMZDelFinder\n'
    'Autorskie narzędzie bioinformatyczne do identyfikacji rzadkich, wewnątrzgenowych delecji homozygotycznych i hemizygotycznych '
    'w danych WES. Kluczowe dla odkrycia delecji w genie TANGO2.\n'
    'Cytowanie: Gambin T et al. "Homozygous and hemizygous CNV detection from exome sequencing data in a Mendelian disease cohort." Nucleic Acids Res. 2017.\n\n'
    '2. Algorytm HMZDupFinder\n'
    'Rozszerzenie metodyki o wykrywanie wewnątrzgenowych duplikacji homozygotycznych, co zwiększyło czułość diagnostyczną '
    'dla rzadkich chorób recesywnych.\n'
    'Cytowanie: Du H, ..., Gambin T, et al. "HMZDupFinder: a robust computational approach for detecting intragenic homozygous duplications..." Nucleic Acids Res. 2024.\n\n'
    '3. Metoda Alubaster (Detekcja Eksonizacji Alu)\n'
    'Współudział w opracowaniu metody wykrywania nowych zdarzeń eksonizacji elementów Alu z danych RNA-seq, co otwiera nowe '
    'ścieżki diagnostyczne dla wariantów niekodujących.\n'
    'Cytowanie: Payer LM, ..., Gambin T, et al. "Detection of Alu exonization events in human frontal cortex from RNA-seq data." Nucleic Acids Res. 2019.\n\n'
    '4. Optymalizacja Potoków Analizy WES/CNV\n'
    'Wdrożenie zintegrowanych potoków analitycznych dla dużych kohort (np. BHCMG), łączących wykrywanie SNV i CNV, '
    'co pozwoliło na "odzyskanie" diagnoz w przypadkach takich jak ANKLE2 czy PGM3.'
)
