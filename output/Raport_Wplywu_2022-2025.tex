...
\begin{enumerate}
    ...
    Z pobranego zbioru wybrano tylko te zgłoszenia, które zostały utworzone lub zaktualizowane w okresie od 1 stycznia 2022 do 7 grudnia 2025. Pozwala to na ocenę wpływu publikacji w okresie objętym ewaluacją.
...
Poniższa tabela przedstawia listę nowych genów chorobowych zidentyfikowanych przy udziale Tomasza Gambina. Są to geny, dla których po raz pierwszy opisano związek z chorobą u ludzi. Tomasz Gambin jest współautorem wszystkich cytowanych poniżej publikacji.
...
W tej sekcji przedstawiono geny, dla których badania Tomasza Gambina przyczyniły się do istotnego poszerzenia spektrum fenotypowego lub lepszego zrozumienia mechanizmu choroby. Tomasz Gambin jest współautorem wszystkich cytowanych poniżej publikacji.
...
Poniższa tabela zawiera geny kluczowe dla rozwoju płuc, w przypadku których badania koncentrowały się na roli sekwencji regulatorowych i niekodujących (CNV, SNV w regionach niekodujących). Tomasz Gambin jest współautorem wszystkich cytowanych poniżej publikacji.
