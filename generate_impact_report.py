...
plt.title('Liczba diagnoz (zgloszen Pathogenic/Likely Pathogenic) w latach 2022-2025')
plt.xlabel('Rok')
...
plt.title('Liczba diagnoz wg genu (2022-2025)')
plt.xlabel('Gen')
plt.ylabel('Liczba zgloszen')
...
plt.title('Globalny zasieg: Osrodki diagnozujace (2022-2025)', fontsize=15)
plt.axis('off')
